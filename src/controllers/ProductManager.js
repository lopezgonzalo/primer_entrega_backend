...
("Producto1","producto 1",1000,"#101",5,"A",true,[]);

const p1 = new Product ("Producto 1","producto 1",1000,"#101",5,"A",true,[]);
const p2 = new Product ("Producto 2","producto 2",1000,"#102",5,"A",true,[]);
const p3 = new Product ("Producto 3","producto 3",1000,"#103",5,"A",true,[]);
const p4 = new Product ("Producto 4","producto 4",1000,"#104",5,"A",true,[]);
